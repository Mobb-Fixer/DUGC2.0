...
import { DownloadNoticeMinorServiceService } from '../nm/download-notice-minor-service.service';
...
export class MintsComponent implements OnInit {
  ...
  DownloadNoticeMinor() {
    ...
    this.service.downloadMOMMakeupCircular().subscribe((data: Blob | MediaSource) => {
